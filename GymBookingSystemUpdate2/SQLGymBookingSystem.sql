...
-- Create GYM_BRANCHES table (with auto-incremented BranchID)
...
-- Chèn dữ liệu vào GYM_BRANCHES (18 chi nhánh, BranchID tự động tăng)
...
VALUES 
(1, 'images/images_gym1.jpg', N'Phòng tập chính', 1, 1, 1), 
(2, 'images/images_gym2.jpg', N'Phòng tập chính', 1, 1, 1), 
(3, 'images/images_gym3.jpg', N'Phòng tập chính', 1, 1, 1), 
(4, 'images/images_gym4.jpg', N'Phòng tập chính', 1, 1, 1), 
(5, 'images/images_gym5.jpg', N'Phòng tập chính', 1, 1, 1), 
(6, 'images/images_gym6.jpg', N'Phòng tập chính', 1, 1, 1),
(7, 'images/images_gym7.jpg', N'Phòng tập chính', 1, 1, 1), 
(8, 'images/images_gym8.jpg', N'Phòng tập chính', 1, 1, 1), 
(9, 'images/images_gym9.jpg', N'Phòng tập chính', 1, 1, 1), 
(10, 'images/images_gym10.jpg', N'Phòng tập chính', 1, 1, 1), 
(11, 'images/images_gym11.jpg', N'Phòng tập chính', 1, 1, 1), 
(12, 'images/images_gym12.jpg', N'Phòng tập chính', 1, 1, 1), 
(13, 'images/images_gym13.jpg', N'Phòng tập chính', 1, 1, 1), 
(14, 'images/images_gym14.jpg', N'Phòng tập chính', 1, 1, 1), 
(15, 'images/images_gym15.jpg', N'Phòng tập chính', 1, 1, 1), 
(16, 'images/images_gym16.jpg', N'Phòng tập chính', 1, 1, 1), 
(17, 'images/images_gym17.jpg', N'Phòng tập chính', 1, 1, 1), 
(18, 'images/images_gym18.jpg', N'Phòng tập chính', 1, 1, 1);
GO
...
-- Chèn dữ liệu vào BOOKINGS (sử dụng BranchID và PackageID từ 1 đến 18)
...
VALUES 
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 1, 1, 1, '2025-04-01', '2025-04-01', '2025-04-30', 500000, 50000, 450000, 'Confirmed', 'Paid', '2025-04-01', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 2, 2, 2, '2025-04-02', '2025-04-02', '2025-04-30', 600000, 50000, 550000, 'Confirmed', 'Paid', '2025-04-02', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 3, 3, 3, '2025-04-03', '2025-04-03', '2025-04-30', 700000, 50000, 650000, 'Confirmed', 'Paid', '2025-04-03', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 4, 4, 4, '2025-04-04', '2025-04-04', '2025-04-30', 550000, 50000, 500000, 'Confirmed', 'Paid', '2025-04-04', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 5, 5, 5, '2025-04-05', '2025-04-05', '2025-04-30', 520000, 40000, 480000, 'Confirmed', 'Paid', '2025-04-05', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 6, 6, 6, '2025-04-06', '2025-04-06', '2025-04-30', 580000, 50000, 530000, 'Confirmed', 'Paid', '2025-04-06', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 7, 7, 7, '2025-04-07', '2025-04-07', '2025-04-30', 560000, 50000, 510000, 'Confirmed', 'Paid', '2025-04-07', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 8, 8, 8, '2025-04-08', '2025-04-08', '2025-04-30', 590000, 50000, 540000, 'Confirmed', 'Paid', '2025-04-08', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 9, 9, 9, '2025-04-09', '2025-04-09', '2025-04-30', 570000, 50000, 520000, 'Confirmed', 'Paid', '2025-04-09', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 10, 10, 10, '2025-04-10', '2025-04-10', '2025-04-30', 540000, 50000, 490000, 'Confirmed', 'Paid', '2025-04-10', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 11, 11, 11, '2025-04-11', '2025-04-11', '2025-04-30', 600000, 50000, 550000, 'Confirmed', 'Paid', '2025-04-11', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 12, 12, 12, '2025-04-12', '2025-04-12', '2025-04-30', 560000, 50000, 510000, 'Confirmed', 'Paid', '2025-04-12', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 13, 13, 13, '2025-04-13', '2025-04-13', '2025-04-30', 570000, 50000, 520000, 'Confirmed', 'Paid', '2025-04-13', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 14, 14, 14, '2025-04-14', '2025-04-14', '2025-04-30', 550000, 50000, 500000, 'Confirmed', 'Paid', '2025-04-14', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 15, 15, 15, '2025-04-15', '2025-04-15', '2025-04-30', 580000, 50000, 530000, 'Confirmed', 'Paid', '2025-04-15', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 16, 16, 16, '2025-04-16', '2025-04-16', '2025-04-30', 540000, 50000, 490000, 'Confirmed', 'Paid', '2025-04-16', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 17, 17, 17, '2025-04-17', '2025-04-17', '2025-04-30', 560000, 50000, 510000, 'Confirmed', 'Paid', '2025-04-17', 1),
(CAST(CAST(NEWID() AS VARCHAR(36)) AS NVARCHAR(20)), 18, 18, 18, '2025-04-18', '2025-04-18', '2025-04-30', 570000, 50000, 520000, 'Confirmed', 'Paid', '2025-04-18', 1);
GO

-- Chèn dữ liệu vào REVIEWS (sử dụng BranchID từ 1 đến 18)
INSERT INTO REVIEWS (BookingID, UserID, BranchID, Rating, Comment, ReviewDate, IsApproved, IsActive)
VALUES 
(1, 1, 1, 4, N'Phòng gym sạch sẽ, máy móc hiện đại!', '2025-04-01', 1, 1), -- Gym ABC Đà Nẵng
(2, 2, 2, 5, N'Dịch vụ tuyệt vời, nhân viên thân thiện!', '2025-04-02', 1, 1), -- Gym DEF Hà Nội
(3, 3, 3, 4, N'Không gian rộng rãi, nhưng cần thêm máy tập!', '2025-04-03', 1, 1), -- Gym GHI TP.HCM
(4, 4, 4, 3, N'Phòng gym ổn, nhưng giờ mở cửa hơi hạn chế.', '2025-04-04', 1, 1), -- Gym JKL Huế
(5, 5, 5, 5, N'Rất hài lòng, sẽ quay lại thường xuyên!', '2025-04-05', 1, 1), -- Gym MNO Cần Thơ
(6, 6, 6, 4, N'Máy móc tốt, nhưng hơi đông vào giờ cao điểm.', '2025-04-06', 1, 1), -- Gym PQR Nha Trang
(7, 7, 7, 4, N'Không gian yên tĩnh, thích hợp để tập luyện.', '2025-04-07', 1, 1), -- Gym STU Đà Lạt
(8, 8, 8, 5, N'Phòng gym tuyệt vời, có cả phòng xông hơi!', '2025-04-08', 1, 1), -- Gym VWX Vũng Tàu
(9, 9, 9, 4, N'Huấn luyện viên nhiệt tình, hỗ trợ tốt.', '2025-04-09', 1, 1), -- Gym YZA Hải Phòng
(10, 10, 10, 3, N'Cần cải thiện vệ sinh khu vực phòng tắm.', '2025-04-10', 1, 1), -- Gym BCD Vinh
(11, 11, 11, 5, N'Phòng boxing rất chuyên nghiệp!', '2025-04-11', 1, 1), -- Gym EFG Quy Nhơn
(12, 12, 12, 4, N'Phòng gym tốt, nhưng bãi đỗ xe hơi nhỏ.', '2025-04-12', 1, 1), -- Gym HIJ Buôn Ma Thuột
(13, 13, 13, 4, N'Không gian thoáng đãng, thích hợp tập yoga.', '2025-04-13', 1, 1), -- Gym KLM Pleiku
(14, 14, 14, 5, N'Dịch vụ tốt, giá cả hợp lý!', '2025-04-14', 1, 1), -- Gym NOP Rạch Giá
(15, 15, 15, 4, N'Phòng gym sạch sẽ, nhân viên nhiệt tình.', '2025-04-15', 1, 1), -- Gym QRS Long Xuyên
(16, 16, 16, 3, N'Cần thêm máy chạy bộ, hơi thiếu thiết bị.', '2025-04-16', 1, 1), -- Gym TUV Mỹ Tho
(17, 17, 17, 5, N'Rất hài lòng với phòng tập tại đây!', '2025-04-17', 1, 1), -- Gym WXY Bạc Liêu
(18, 18, 18, 4, N'Phòng gym ổn, cần cải thiện ánh sáng.', '2025-04-18', 1, 1); -- Gym ZAB Cà Mau
GO


SELECT * FROM USERS;
SELECT * FROM GYM_PROVIDERS;
SELECT * FROM GYM_BRANCHES;
